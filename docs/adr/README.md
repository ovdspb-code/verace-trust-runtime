...
| [ADR-TR005](ADR-TR005-Receipt-and-Approval-Policy.md) | Proposed v1.0 | - | Defines the first receipt, approval, review, and block policy for Founder Assistant and Verace Runtime actions. |
