...
| No runtime schema migration runner | Open | ADR-TR006 is accepted; BRIEF-TR003 implements schema metadata, fail-closed inspection, and a minimal migration runner before the next persistent feature. |
